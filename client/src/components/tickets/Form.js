...
export default class TicketsForm extends React.Component{
    constructor(props){
        ...
        this.state={
            ...
            employeesIds:props.ticket?props.ticket.employeesIds.map(e1=>{return e1._id}):[],
            // employeesIds:[],
            // empId:"",
            customers:[],
            departments:[],
    ...
    handleDeptChange=(e)=>{
        ...
        axios.get("/employees",{
            ...
            .then(response=>{
                const empl=response.data.filter(e1=>e1.deptId._id==this.state.departmentId)
        ...
        return (
            <div>
                <form onSubmit={this.handleSubmit}>
                    ...
                    <div>
                        <Select defaultValue={{ label: "Select Customer", value: 0 }} onChange={this.handleChange} options={this.state.customers}/>
                    </div>
                    <br/>
                    <label>
                        Department
                    ...
                    <div>
                        <Select defaultValue={{ label: "Select Department", value: 0 }} onChange={this.handleDeptChange} options={this.state.departments}/>
                    </div>
                    <br/>
                    <label>
                        Employees
                        ...
                        <div>
                            <Select isMulti  onChange={this.handleMultiChange} options={this.state.employees}/>
                        </div>
                    <br/>
                    <label>
                        message
                    ...
                    <label>
                        <input type="radio" value="high" checked={this.state.priority==="high"} onChange={this.handleChange} name="priority"/>HIGH
                    </label><br/>
                    <label>
                        <input type="radio" value="medium" checked={this.state.priority==="medium"} onChange={this.handleChange} name="priority"/>MEDIUM
                    </label><br/>
                    <label>
                        <input type="radio" value="low" checked={this.state.priority==="low"} onChange={this.handleChange} name="priority"/>LOW
                    </label><br/>
                    <input type="submit"/>
                </form>           
